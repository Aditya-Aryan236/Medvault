...
rs_initiate_if_needed \
  ...
  "configsvr1" \
  "27019" \
  'rs.initiate({_id: "csrs", configsvr: true, members: [{_id: 0, host: "configsvr1:27019"}, {_id: 1, host: "configsvr2:27019"}, {_id: 2, host: "configsvr3:27019"}]})'
...
rs_initiate_if_needed \
  ...
  "shard1a" \
  "27018" \
  'rs.initiate({_id: "sh1rs", members: [{_id: 0, host: "shard1a:27018"}, {_id: 1, host: "shard1b:27018"}, {_id: 2, host: "shard1c:27018"}]})'
...
rs_initiate_if_needed \
  ...
  "shard2" \
  "27018" \
  'rs.initiate({_id: "sh2rs", members: [{_id: 0, host: "shard2:27018"}]})'
...
mongosh --host mongos-router --port 27017 --eval 'sh.addShard("sh1rs/shard1a:27018,shard1b:27018,shard1c:27018")' || true
mongosh --host mongos-router --port 27017 --eval 'sh.addShard("sh2rs/shard2:27018")' || true
